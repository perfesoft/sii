/**
 * RespuestaOperacionesSegurosType.java
 *
 ...
 */
public class RespuestaOperacionesSegurosType  implements java.io.Serializable {
    private es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaSuministro_xsd.RespuestaOperacionesSegurosTypePeriodoImpositivo periodoImpositivo;
    ...
    public RespuestaOperacionesSegurosType() {
    }

    public RespuestaOperacionesSegurosType(
           es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaSuministro_xsd.RespuestaOperacionesSegurosTypePeriodoImpositivo periodoImpositivo,
    ...
    /**
     * Gets the periodoImpositivo value for this RespuestaOperacionesSegurosType.
     * 
     * @return periodoImpositivo
     */
    public es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaSuministro_xsd.RespuestaOperacionesSegurosTypePeriodoImpositivo getPeriodoImpositivo() {
        return periodoImpositivo;
    }


    /**
     * Sets the periodoImpositivo value for this RespuestaOperacionesSegurosType.
     * 
     * @param periodoImpositivo
     */
    public void setPeriodoImpositivo(es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaSuministro_xsd.RespuestaOperacionesSegurosTypePeriodoImpositivo periodoImpositivo) {
        this.periodoImpositivo = periodoImpositivo;
    }


    /**
     * Gets the contraparte value for this RespuestaOperacionesSegurosType.
     * 
    ...
    /**
     * Sets the contraparte value for this RespuestaOperacionesSegurosType.
     * 
    ...
    /**
     * Gets the claveOperacion value for this RespuestaOperacionesSegurosType.
     * 
    ...
    /**
     * Sets the claveOperacion value for this RespuestaOperacionesSegurosType.
     * 
    ...
    /**
     * Gets the estadoRegistro value for this RespuestaOperacionesSegurosType.
     * 
    ...
    /**
     * Sets the estadoRegistro value for this RespuestaOperacionesSegurosType.
     * 
    ...
    /**
     * Gets the codigoErrorRegistro value for this RespuestaOperacionesSegurosType.
     * 
    ...
    /**
     * Sets the codigoErrorRegistro value for this RespuestaOperacionesSegurosType.
     * 
    ...
    /**
     * Gets the descripcionErrorRegistro value for this RespuestaOperacionesSegurosType.
     * 
    ...
    /**
     * Sets the descripcionErrorRegistro value for this RespuestaOperacionesSegurosType.
     * 
    ...
    /**
     * Gets the CSV value for this RespuestaOperacionesSegurosType.
     * 
    ...
    /**
     * Sets the CSV value for this RespuestaOperacionesSegurosType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RespuestaOperacionesSegurosType)) return false;
        RespuestaOperacionesSegurosType other = (RespuestaOperacionesSegurosType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RespuestaOperacionesSegurosType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaSuministro.xsd", "RespuestaOperacionesSegurosType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaSuministro.xsd", ">RespuestaOperacionesSegurosType>PeriodoImpositivo"));
