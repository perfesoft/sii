/**
 * SujetaPrestacionTypeNoExenta.java
 *
...
public class SujetaPrestacionTypeNoExenta  implements java.io.Serializable {
    ...
    private es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.DetalleIVAEmitidaPrestacionType[] desgloseIVA;

    public SujetaPrestacionTypeNoExenta() {
    }
    ...
    public SujetaPrestacionTypeNoExenta(
           ...
           es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.DetalleIVAEmitidaPrestacionType[] desgloseIVA) {
    ...
    /**
     * Gets the tipoNoExenta value for this SujetaPrestacionTypeNoExenta.
     * 
     * @return tipoNoExenta
     */
    ...
    /**
     * Sets the tipoNoExenta value for this SujetaPrestacionTypeNoExenta.
     * 
     * @param tipoNoExenta
     */
    ...
    /**
     * Gets the desgloseIVA value for this SujetaPrestacionTypeNoExenta.
     * 
     * @return desgloseIVA
     */
    public es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.DetalleIVAEmitidaPrestacionType[] getDesgloseIVA() {
        return desgloseIVA;
    }


    /**
     * Sets the desgloseIVA value for this SujetaPrestacionTypeNoExenta.
     * 
     * @param desgloseIVA
     */
    public void setDesgloseIVA(es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.DetalleIVAEmitidaPrestacionType[] desgloseIVA) {
        this.desgloseIVA = desgloseIVA;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SujetaPrestacionTypeNoExenta)) return false;
        SujetaPrestacionTypeNoExenta other = (SujetaPrestacionTypeNoExenta) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SujetaPrestacionTypeNoExenta.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroInformacion.xsd", ">SujetaPrestacionType>NoExenta"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroInformacion.xsd", "DetalleIVAEmitidaPrestacionType"));
        elemField.setNillable(false);
