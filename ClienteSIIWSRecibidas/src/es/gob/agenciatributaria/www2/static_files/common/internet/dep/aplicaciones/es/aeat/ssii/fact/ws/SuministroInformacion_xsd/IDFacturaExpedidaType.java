 ...
 */
public class IDFacturaExpedidaType  implements java.io.Serializable {
    private es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.IDFacturaExpedidaTypeIDEmisorFactura IDEmisorFactura;
    ...
    public IDFacturaExpedidaType() {
    }

    public IDFacturaExpedidaType(
           es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.IDFacturaExpedidaTypeIDEmisorFactura IDEmisorFactura,
    ...
    /**
     * Gets the IDEmisorFactura value for this IDFacturaExpedidaType.
     * 
     * @return IDEmisorFactura
     */
    public es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.IDFacturaExpedidaTypeIDEmisorFactura getIDEmisorFactura() {
        return IDEmisorFactura;
    }


    /**
     * Sets the IDEmisorFactura value for this IDFacturaExpedidaType.
     * 
     * @param IDEmisorFactura
     */
    public void setIDEmisorFactura(es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.IDFacturaExpedidaTypeIDEmisorFactura IDEmisorFactura) {
        this.IDEmisorFactura = IDEmisorFactura;
    }


    /**
     * Gets the numSerieFacturaEmisor value for this IDFacturaExpedidaType.
     * 
    ...
    /**
     * Sets the numSerieFacturaEmisor value for this IDFacturaExpedidaType.
     * 
    ...
    /**
     * Gets the numSerieFacturaEmisorResumenFin value for this IDFacturaExpedidaType.
     * 
    ...
    /**
     * Sets the numSerieFacturaEmisorResumenFin value for this IDFacturaExpedidaType.
     * 
    ...
    /**
     * Gets the fechaExpedicionFacturaEmisor value for this IDFacturaExpedidaType.
     * 
    ...
    /**
     * Sets the fechaExpedicionFacturaEmisor value for this IDFacturaExpedidaType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IDFacturaExpedidaType)) return false;
        IDFacturaExpedidaType other = (IDFacturaExpedidaType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(IDFacturaExpedidaType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroInformacion.xsd", "IDFacturaExpedidaType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroInformacion.xsd", ">IDFacturaExpedidaType>IDEmisorFactura"));
