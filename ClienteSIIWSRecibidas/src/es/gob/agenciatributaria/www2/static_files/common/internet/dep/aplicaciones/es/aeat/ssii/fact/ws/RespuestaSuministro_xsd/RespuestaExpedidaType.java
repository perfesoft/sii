 ...
 */
public class RespuestaExpedidaType  implements java.io.Serializable {
    /* Factura Expedida */
     ...
     * Solo se suministra si la factura enviada es rechazada por estar duplicada */
    private java.lang.String CSV;

    public RespuestaExpedidaType() {
    }
    ...
    /**
     * Gets the IDFactura value for this RespuestaExpedidaType.
     * 
     * @return IDFactura   * Factura Expedida
     */
    ...
    /**
     * Sets the IDFactura value for this RespuestaExpedidaType.
     * 
     * @param IDFactura   * Factura Expedida
     */
    ...
    /**
     * Gets the estadoRegistro value for this RespuestaExpedidaType.
     * 
     * @return estadoRegistro   * Estado del registro. Correcto, Incorrecto o Aceptado con errores
     */
    ...
    /**
     * Sets the estadoRegistro value for this RespuestaExpedidaType.
     * 
     * @param estadoRegistro   * Estado del registro. Correcto, Incorrecto o Aceptado con errores
     */
    ...
    /**
     * Gets the codigoErrorRegistro value for this RespuestaExpedidaType.
     * 
    ...
    /**
     * Sets the codigoErrorRegistro value for this RespuestaExpedidaType.
     * 
    ...
    /**
     * Gets the descripcionErrorRegistro value for this RespuestaExpedidaType.
     * 
    ...
    /**
     * Sets the descripcionErrorRegistro value for this RespuestaExpedidaType.
     * 
    ...
    /**
     * Gets the CSV value for this RespuestaExpedidaType.
     * 
    ...
    /**
     * Sets the CSV value for this RespuestaExpedidaType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RespuestaExpedidaType)) return false;
        RespuestaExpedidaType other = (RespuestaExpedidaType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RespuestaExpedidaType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaSuministro.xsd", "RespuestaExpedidaType"));
