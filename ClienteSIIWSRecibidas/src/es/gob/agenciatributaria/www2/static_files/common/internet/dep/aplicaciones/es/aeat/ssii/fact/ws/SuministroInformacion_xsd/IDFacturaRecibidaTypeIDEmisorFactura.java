/**
 * IDFacturaRecibidaTypeIDEmisorFactura.java
 *
...
public class IDFacturaRecibidaTypeIDEmisorFactura  implements java.io.Serializable {
    ...
    public IDFacturaRecibidaTypeIDEmisorFactura() {
    }
    ...
    /**
     * Gets the NIF value for this IDFacturaRecibidaTypeIDEmisorFactura.
     * 
     * @return NIF
     */
    ...
    /**
     * Sets the NIF value for this IDFacturaRecibidaTypeIDEmisorFactura.
     * 
     * @param NIF
     */
    ...
    /**
     * Gets the IDOtro value for this IDFacturaRecibidaTypeIDEmisorFactura.
     * 
     * @return IDOtro
     */
    ...
    /**
     * Sets the IDOtro value for this IDFacturaRecibidaTypeIDEmisorFactura.
     * 
     * @param IDOtro
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IDFacturaRecibidaTypeIDEmisorFactura)) return false;
        IDFacturaRecibidaTypeIDEmisorFactura other = (IDFacturaRecibidaTypeIDEmisorFactura) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(IDFacturaRecibidaTypeIDEmisorFactura.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroInformacion.xsd", ">IDFacturaRecibidaType>IDEmisorFactura"));
