 ...
 */
public class LRBajaExpedidasType  extends es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.RegistroSii  implements java.io.Serializable {
    ...
    /**
     * Gets the IDFactura value for this LRBajaExpedidasType.
     * 
     * @return IDFactura
     */
    ...
    /**
     * Sets the IDFactura value for this LRBajaExpedidasType.
     * 
     * @param IDFactura
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LRBajaExpedidasType)) return false;
        LRBajaExpedidasType other = (LRBajaExpedidasType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LRBajaExpedidasType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroLR.xsd", "LRBajaExpedidasType"));
