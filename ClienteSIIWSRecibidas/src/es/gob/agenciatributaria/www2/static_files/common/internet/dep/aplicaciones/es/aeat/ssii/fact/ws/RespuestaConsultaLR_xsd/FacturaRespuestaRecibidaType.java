/**
 * FacturaRespuestaRecibidaType.java
 *
 ...
 */
public class FacturaRespuestaRecibidaType  extends es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaConsultaLR_xsd.FacturaRespuestaType  implements java.io.Serializable {
    ...
    private es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaConsultaLR_xsd.FacturaARType pagos;

    public FacturaRespuestaRecibidaType() {
    }
    ...
    public FacturaRespuestaRecibidaType(
           ...
           es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaConsultaLR_xsd.FacturaARType pagos) {
        super(
            tipoFactura,
            tipoRectificativa,
            facturasAgrupadas,
    ...
    /**
     * Gets the desgloseFactura value for this FacturaRespuestaRecibidaType.
     * 
    ...
    /**
     * Sets the desgloseFactura value for this FacturaRespuestaRecibidaType.
     * 
    ...
    /**
     * Gets the contraparte value for this FacturaRespuestaRecibidaType.
     * 
    ...
    /**
     * Sets the contraparte value for this FacturaRespuestaRecibidaType.
     * 
    ...
    /**
     * Gets the fechaRegContable value for this FacturaRespuestaRecibidaType.
     * 
    ...
    /**
     * Sets the fechaRegContable value for this FacturaRespuestaRecibidaType.
     * 
    ...
    /**
     * Gets the cuotaDeducible value for this FacturaRespuestaRecibidaType.
     * 
    ...
    /**
     * Sets the cuotaDeducible value for this FacturaRespuestaRecibidaType.
     * 
    ...
    /**
     * Gets the pagos value for this FacturaRespuestaRecibidaType.
     * 
     * @return pagos
     */
    public es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaConsultaLR_xsd.FacturaARType getPagos() {
        return pagos;
    }


    /**
     * Sets the pagos value for this FacturaRespuestaRecibidaType.
     * 
     * @param pagos
     */
    public void setPagos(es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaConsultaLR_xsd.FacturaARType pagos) {
        this.pagos = pagos;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FacturaRespuestaRecibidaType)) return false;
        FacturaRespuestaRecibidaType other = (FacturaRespuestaRecibidaType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FacturaRespuestaRecibidaType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaConsultaLR.xsd", "FacturaRespuestaRecibidaType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaConsultaLR.xsd", "FechaRegContable"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("cuotaDeducible");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaConsultaLR.xsd", "CuotaDeducible"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("pagos");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaConsultaLR.xsd", "Pagos"));
