 ...
 */
public class IDFacturaComunitariaType  implements java.io.Serializable {
    private es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.IDFacturaComunitariaTypeIDEmisorFactura IDEmisorFactura;
    ...
    public IDFacturaComunitariaType() {
    }

    public IDFacturaComunitariaType(
           es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.IDFacturaComunitariaTypeIDEmisorFactura IDEmisorFactura,
    ...
    /**
     * Gets the IDEmisorFactura value for this IDFacturaComunitariaType.
     * 
     * @return IDEmisorFactura
     */
    public es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.IDFacturaComunitariaTypeIDEmisorFactura getIDEmisorFactura() {
        return IDEmisorFactura;
    }


    /**
     * Sets the IDEmisorFactura value for this IDFacturaComunitariaType.
     * 
     * @param IDEmisorFactura
     */
    public void setIDEmisorFactura(es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.IDFacturaComunitariaTypeIDEmisorFactura IDEmisorFactura) {
        this.IDEmisorFactura = IDEmisorFactura;
    }


    /**
     * Gets the numSerieFacturaEmisor value for this IDFacturaComunitariaType.
     * 
    ...
    /**
     * Sets the numSerieFacturaEmisor value for this IDFacturaComunitariaType.
     * 
    ...
    /**
     * Gets the fechaExpedicionFacturaEmisor value for this IDFacturaComunitariaType.
     * 
    ...
    /**
     * Sets the fechaExpedicionFacturaEmisor value for this IDFacturaComunitariaType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IDFacturaComunitariaType)) return false;
        IDFacturaComunitariaType other = (IDFacturaComunitariaType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(IDFacturaComunitariaType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroInformacion.xsd", "IDFacturaComunitariaType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroInformacion.xsd", ">IDFacturaComunitariaType>IDEmisorFactura"));
