/**
 * RespuestaMetalicoBajaType.java
 *
 ...
 */
public class RespuestaMetalicoBajaType  implements java.io.Serializable {
    private es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaSuministro_xsd.RespuestaMetalicoBajaTypePeriodoImpositivo periodoImpositivo;
     ...
     * es rechazado porque ya está dado de baja */
    private java.lang.String CSV;

    public RespuestaMetalicoBajaType() {
    }

    public RespuestaMetalicoBajaType(
           es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaSuministro_xsd.RespuestaMetalicoBajaTypePeriodoImpositivo periodoImpositivo,
    ...
    /**
     * Gets the periodoImpositivo value for this RespuestaMetalicoBajaType.
     * 
     * @return periodoImpositivo
     */
    public es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaSuministro_xsd.RespuestaMetalicoBajaTypePeriodoImpositivo getPeriodoImpositivo() {
        return periodoImpositivo;
    }


    /**
     * Sets the periodoImpositivo value for this RespuestaMetalicoBajaType.
     * 
     * @param periodoImpositivo
     */
    public void setPeriodoImpositivo(es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaSuministro_xsd.RespuestaMetalicoBajaTypePeriodoImpositivo periodoImpositivo) {
        this.periodoImpositivo = periodoImpositivo;
    }


    /**
     * Gets the contraparte value for this RespuestaMetalicoBajaType.
     * 
    ...
    /**
     * Sets the contraparte value for this RespuestaMetalicoBajaType.
     * 
    ...
    /**
     * Gets the estadoRegistro value for this RespuestaMetalicoBajaType.
     * 
    ...
    /**
     * Sets the estadoRegistro value for this RespuestaMetalicoBajaType.
     * 
    ...
    /**
     * Gets the codigoErrorRegistro value for this RespuestaMetalicoBajaType.
     * 
    ...
    /**
     * Sets the codigoErrorRegistro value for this RespuestaMetalicoBajaType.
     * 
    ...
    /**
     * Gets the descripcionErrorRegistro value for this RespuestaMetalicoBajaType.
     * 
    ...
    /**
     * Sets the descripcionErrorRegistro value for this RespuestaMetalicoBajaType.
     * 
    ...
    /**
     * Gets the CSV value for this RespuestaMetalicoBajaType.
     * 
    ...
    /**
     * Sets the CSV value for this RespuestaMetalicoBajaType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RespuestaMetalicoBajaType)) return false;
        RespuestaMetalicoBajaType other = (RespuestaMetalicoBajaType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RespuestaMetalicoBajaType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaSuministro.xsd", "RespuestaMetalicoBajaType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaSuministro.xsd", ">RespuestaMetalicoBajaType>PeriodoImpositivo"));
