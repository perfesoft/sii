 ...
 */
public class RespuestaComunBajaType  implements java.io.Serializable {
    ...
    private es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.CabeceraSiiBaja cabecera;
    ...
    /**
     * Gets the CSV value for this RespuestaComunBajaType.
     * 
    ...
    /**
     * Sets the CSV value for this RespuestaComunBajaType.
     * 
    ...
    /**
     * Gets the datosPresentacion value for this RespuestaComunBajaType.
     * 
    ...
    /**
     * Sets the datosPresentacion value for this RespuestaComunBajaType.
     * 
    ...
    /**
     * Gets the cabecera value for this RespuestaComunBajaType.
     * 
     * @return cabecera   * Se devuelve la cabecera que se incluó en el envío.
     */
    public es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.CabeceraSiiBaja getCabecera() {
        return cabecera;
    }


    /**
     * Sets the cabecera value for this RespuestaComunBajaType.
     * 
     * @param cabecera   * Se devuelve la cabecera que se incluó en el envío.
     */
    public void setCabecera(es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.CabeceraSiiBaja cabecera) {
        this.cabecera = cabecera;
    }


    /**
     * Gets the estadoEnvio value for this RespuestaComunBajaType.
     * 
    ...
    /**
     * Sets the estadoEnvio value for this RespuestaComunBajaType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RespuestaComunBajaType)) return false;
        RespuestaComunBajaType other = (RespuestaComunBajaType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RespuestaComunBajaType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaSuministro.xsd", "RespuestaComunBajaType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroInformacion.xsd", "CabeceraSiiBaja"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
