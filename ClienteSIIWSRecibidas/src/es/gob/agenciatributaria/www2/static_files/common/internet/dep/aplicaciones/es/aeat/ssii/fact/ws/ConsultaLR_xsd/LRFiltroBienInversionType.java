/**
 * LRFiltroBienInversionType.java
 *
...
public class LRFiltroBienInversionType  extends es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.RegistroSii  implements java.io.Serializable {
    ...
    private es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.ClavePaginacionBienType clavePaginacion;

    public LRFiltroBienInversionType() {
    }
    ...
    public LRFiltroBienInversionType(
           ...
           es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.ClavePaginacionBienType clavePaginacion) {
        super(
            periodoImpositivo);
    ...
    /**
     * Gets the IDFactura value for this LRFiltroBienInversionType.
     * 
     * @return IDFactura
     */
    ...
    /**
     * Sets the IDFactura value for this LRFiltroBienInversionType.
     * 
     * @param IDFactura
     */
    ...
    /**
     * Gets the fechaPresentacion value for this LRFiltroBienInversionType.
     * 
    ...
    /**
     * Sets the fechaPresentacion value for this LRFiltroBienInversionType.
     * 
    ...
    /**
     * Gets the facturaModificada value for this LRFiltroBienInversionType.
     * 
    ...
    /**
     * Sets the facturaModificada value for this LRFiltroBienInversionType.
     * 
    ...
    /**
     * Gets the identificacionBien value for this LRFiltroBienInversionType.
     * 
    ...
    /**
     * Sets the identificacionBien value for this LRFiltroBienInversionType.
     * 
    ...
    /**
     * Gets the clavePaginacion value for this LRFiltroBienInversionType.
     * 
     * @return clavePaginacion
     */
    public es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.ClavePaginacionBienType getClavePaginacion() {
        return clavePaginacion;
    }


    /**
     * Sets the clavePaginacion value for this LRFiltroBienInversionType.
     * 
     * @param clavePaginacion
     */
    public void setClavePaginacion(es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.ClavePaginacionBienType clavePaginacion) {
        this.clavePaginacion = clavePaginacion;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LRFiltroBienInversionType)) return false;
        LRFiltroBienInversionType other = (LRFiltroBienInversionType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LRFiltroBienInversionType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/ConsultaLR.xsd", "LRFiltroBienInversionType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/ConsultaLR.xsd", "IdentificacionBien"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroInformacion.xsd", "ClavePaginacionBienType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
