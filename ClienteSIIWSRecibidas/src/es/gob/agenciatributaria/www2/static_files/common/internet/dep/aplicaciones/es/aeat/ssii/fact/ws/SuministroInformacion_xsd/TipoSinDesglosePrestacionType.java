/**
 * TipoSinDesglosePrestacionType.java
 *
 ...
 */
public class TipoSinDesglosePrestacionType  implements java.io.Serializable {
    private es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.SujetaPrestacionType sujeta;
    ...
    public TipoSinDesglosePrestacionType() {
    }

    public TipoSinDesglosePrestacionType(
           es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.SujetaPrestacionType sujeta,
    ...
    /**
     * Gets the sujeta value for this TipoSinDesglosePrestacionType.
     * 
     * @return sujeta
     */
    public es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.SujetaPrestacionType getSujeta() {
        return sujeta;
    }


    /**
     * Sets the sujeta value for this TipoSinDesglosePrestacionType.
     * 
     * @param sujeta
     */
    public void setSujeta(es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.SuministroInformacion_xsd.SujetaPrestacionType sujeta) {
        this.sujeta = sujeta;
    }


    /**
     * Gets the noSujeta value for this TipoSinDesglosePrestacionType.
     * 
     * @return noSujeta
     */
    ...
    /**
     * Sets the noSujeta value for this TipoSinDesglosePrestacionType.
     * 
     * @param noSujeta
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TipoSinDesglosePrestacionType)) return false;
        TipoSinDesglosePrestacionType other = (TipoSinDesglosePrestacionType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TipoSinDesglosePrestacionType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroInformacion.xsd", "TipoSinDesglosePrestacionType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/SuministroInformacion.xsd", "SujetaPrestacionType"));
