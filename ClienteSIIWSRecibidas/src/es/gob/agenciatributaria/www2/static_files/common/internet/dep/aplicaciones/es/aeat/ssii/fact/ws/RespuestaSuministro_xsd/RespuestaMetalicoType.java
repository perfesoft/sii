 ...
 */
public class RespuestaMetalicoType  implements java.io.Serializable {
    private es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaSuministro_xsd.RespuestaMetalicoTypePeriodoImpositivo periodoImpositivo;
    ...
    public RespuestaMetalicoType() {
    }

    public RespuestaMetalicoType(
           es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaSuministro_xsd.RespuestaMetalicoTypePeriodoImpositivo periodoImpositivo,
    ...
    /**
     * Gets the periodoImpositivo value for this RespuestaMetalicoType.
     * 
     * @return periodoImpositivo
     */
    public es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaSuministro_xsd.RespuestaMetalicoTypePeriodoImpositivo getPeriodoImpositivo() {
        return periodoImpositivo;
    }


    /**
     * Sets the periodoImpositivo value for this RespuestaMetalicoType.
     * 
     * @param periodoImpositivo
     */
    public void setPeriodoImpositivo(es.gob.agenciatributaria.www2.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.RespuestaSuministro_xsd.RespuestaMetalicoTypePeriodoImpositivo periodoImpositivo) {
        this.periodoImpositivo = periodoImpositivo;
    }


    /**
     * Gets the contraparte value for this RespuestaMetalicoType.
     * 
    ...
    /**
     * Sets the contraparte value for this RespuestaMetalicoType.
     * 
    ...
    /**
     * Gets the estadoRegistro value for this RespuestaMetalicoType.
     * 
    ...
    /**
     * Sets the estadoRegistro value for this RespuestaMetalicoType.
     * 
    ...
    /**
     * Gets the codigoErrorRegistro value for this RespuestaMetalicoType.
     * 
    ...
    /**
     * Sets the codigoErrorRegistro value for this RespuestaMetalicoType.
     * 
    ...
    /**
     * Gets the descripcionErrorRegistro value for this RespuestaMetalicoType.
     * 
    ...
    /**
     * Sets the descripcionErrorRegistro value for this RespuestaMetalicoType.
     * 
    ...
    /**
     * Gets the CSV value for this RespuestaMetalicoType.
     * 
    ...
    /**
     * Sets the CSV value for this RespuestaMetalicoType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RespuestaMetalicoType)) return false;
        RespuestaMetalicoType other = (RespuestaMetalicoType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RespuestaMetalicoType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaSuministro.xsd", "RespuestaMetalicoType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaSuministro.xsd", ">RespuestaMetalicoType>PeriodoImpositivo"));
